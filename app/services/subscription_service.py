    ...
    async def create_subscription(
        ...
        async with get_db_session() as session:
            subscription = Subscription(
                ...
                notification_slack_webhooks=json.dumps(notification_slack_webhooks) if notification_slack_webhooks else None,
                notification_custom_webhooks=json.dumps(notification_custom_webhooks) if notification_custom_webhooks else None,
